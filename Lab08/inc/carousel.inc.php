...
<section role="region" aria-label="Membership Options Carousel">
  <div id="gymCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <!-- Carousel Controls -->
    <button class="carousel-control-prev" type="button" aria-label="Previous slide" data-bs-target="#gymCarousel" data-bs-slide="prev">
      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
      <span class="visually-hidden">Previous</span>
    </button>
    <button class="carousel-control-next" type="button" aria-label="Next slide" data-bs-target="#gymCarousel" data-bs-slide="next">
