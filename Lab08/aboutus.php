...
<html lang="en">
    <head>
        <title>About Us - Fitness Gym</title>
        <?php
    ...
    <body>
        ...
        <main class="container">
            ...
            <section class="py-5 text-center">
                <h1 class="display-4">About Fitness Gym</h1>
            ...
            <section class="container my-5">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-4 mb-lg-0">
                        <h2>Our Story</h2>
                        <p>Founded in 2010, Fitness Gym began with a simple mission: to create a welcoming environment where people of all fitness levels could achieve their health goals.</p>
                    ...
                    <div class="col-lg-6">
                        <img src="images/basic_membership.png" alt="Our gym's journey" class="img-fluid rounded shadow">
                    </div>
                </div>
            </section>
            
            <!-- Our Mission Section -->
            <section class="container my-5 bg-light p-5 rounded">
            ...
            <section class="container my-5">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="card h-100 shadow-sm">
                            <div class="card-body">
                                <p class="card-text">"Joining Fitness Gym was the best decision I've made for my health. The trainers are knowledgeable, the equipment is top-notch, and the community is so supportive."</p>
                    ...
                    <div class="col-md-6">
                        <div class="card h-100 shadow-sm">
                            <div class="card-body">
                                <p class="card-text">"As someone who was intimidated by gyms, Fitness Gym changed my perspective completely. The staff is friendly, and I've achieved results I never thought possible."</p>
                                <div class="d-flex align-items-center mt-3">
                                    <img src="images/peter.png" class="rounded-circle me-3" width="50" height="50" alt="Member">
                                    <div>
